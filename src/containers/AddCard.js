...
class AddCard extends Component {
    ...
    onSubmit = () => {
        ...
        const {createCard, goBack} = this.props;
        ...
        return (
            <View style={{flex: 1}}>
                ...
                <View style={globalStyles.viewContainer}>
                    ...
                    <TextInput value={this.state.question} onChangeText={this.onQuestionChange}
                    ...
                    <TextInput value={this.state.answer} onChangeText={this.onAnswerChange}
                               style={globalStyles.textInput}/>
...
function mapDispatchToProps(dispatch, {navigation}) {
    ...
    return {
        createCard: (question, answer) => {
            ...
            dispatch(createCard(questionDetails));
        },
